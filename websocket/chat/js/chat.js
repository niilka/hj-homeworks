...
ws.addEventListener('message', (event) => {
  ...
  if (data === '...') {
    chatElems.content.appendChild(typingMessage).scrollIntoView({
      block: "end",
      behavior: "smooth"
    });
  } else {
    ...
    chatElems.content.appendChild(messageUser).scrollIntoView({
      block: "end",
      behavior: "smooth"
    });
  }
...
chatElems.form.addEventListener('submit', (event) => {
  ...
  chatElems.content.appendChild(messageMy).scrollIntoView({
    block: "end",
    behavior: "smooth"
  });
  ws.send(value);
